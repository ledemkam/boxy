...
export default function CancelledPage() {
  ...
  return (
      ...
      <h1 className="text-xl  font-black mb-2 text-center uppercase ">Zahlung fehlgeschlagen!</h1>
      <p className="text-muted-foreground text-sm mb-2">Hoppla, es ist ein Fehler aufgetreten</p>
